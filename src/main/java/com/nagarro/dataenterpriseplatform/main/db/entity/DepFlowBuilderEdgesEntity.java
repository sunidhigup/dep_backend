...
import com.nagarro.dataenterpriseplatform.main.db.converter.StringArrayAttributeConverter;
...
@AllArgsConstructor
@NoArgsConstructor
@Entity(name = "dep_flow_builder_edges")
@TypeDef(name = "jsonb", typeClass = JsonBinaryType.class)
public class DepFlowBuilderEdgesEntity implements Serializable {
